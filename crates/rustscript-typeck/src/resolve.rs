...
//! literal expressions. Originally extracted from `rustscript-lower/src/types.rs`.
...
/// to [`rustscript_syntax::rust_ir::RustType`] via the bridge. It preserves the exact
/// behavior of the original `rustscript-lower/types.rs` resolution.
pub fn resolve_type_annotation_to_rust_type(
    ann: &ast::TypeAnnotation,
    diagnostics: &mut Vec<Diagnostic>,
) -> rustscript_syntax::rust_ir::RustType {
...
#[must_use]
pub fn infer_literal_rust_type(expr: &ast::Expr) -> Option<rustscript_syntax::rust_ir::RustType> {
...
mod tests {
    use super::*;
    use rustscript_syntax::ast::{Expr, ExprKind, Ident, TypeAnnotation, TypeKind};
    ...
    fn test_resolve_type_annotation_unknown_to_rust_type() {
        ...
        assert_eq!(
            rust_ty,
            rustscript_syntax::rust_ir::RustType::BoxDynAny,
