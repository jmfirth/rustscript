...
use rustscript_syntax::rust_ir::{ParamMode, RustType};
...
pub(crate) fn is_copy_type_with_registry(
    ty: &RustType,
    registry: Option<&rustscript_typeck::registry::TypeRegistry>,
) -> bool {
    match ty {
        RustType::I8
        | RustType::I16
...
mod tests {
    ...
    fn test_rust_param_owned_mode_preserves_behavior() {
        use rustscript_syntax::rust_ir::{ParamMode, RustParam};
    ...
    fn test_is_copy_type_simple_enum_with_registry() {
        let mut registry = rustscript_typeck::registry::TypeRegistry::new();
