...
";
    ...
    fn test_emit_compound_assign_add() {
        use rustscript_syntax::rust_ir::RustCompoundAssignOp;
        let file = simple_fn(
            "main",
    ...
    fn test_emit_destructure_defaults() {
        use rustscript_syntax::rust_ir::{
            RustDestructureDefaultField, RustDestructureDefaultsStmt,
        };
        let file = simple_fn(
            "main",
    ...
    fn test_emit_closure_expr_body() {
        use rustscript_syntax::rust_ir::{RustClosureBody, RustClosureParam};
        let file = simple_fn(
            "main",
            vec![RustStmt::Let(RustLetStmt {
                mutable: false,
    ...
    fn test_emit_closure_block_body() {
        use rustscript_syntax::rust_ir::RustClosureBody;
        let file = simple_fn(
            "main",
            vec![RustStmt::Let(RustLetStmt {
                mutable: false,
    ...
    fn test_emit_tokio_main_attribute_on_async_main() {
        use rustscript_syntax::rust_ir::RustAttribute;
    ...
    fn test_emit_tuple_destructure_let_binding() {
        use rustscript_syntax::rust_ir::RustTupleDestructureStmt;
    ...
    fn test_emit_param_mode_borrowed_str() {
        let span = rustscript_syntax::span::Span::new(0, 10);
        let file = RustFile {
            uses: vec![],
            mod_decls: vec![],
            test_module: None,
