...
2. It adds `axum = "..."` to the generated `Cargo.toml` in `.rsc-build/`
...
Your source `cargo.toml` is minimal:
...
The compiler generates a full `Cargo.toml` in `.rsc-build/`:
...
You never edit this generated file. It's rebuilt from your imports every time you compile.
