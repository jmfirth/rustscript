...
If you find yourself writing a lot of rust blocks, you might be ready to eject. Copy the generated `.rs` from `.rsc-build/` into a pure Rust project and continue there. That's by design -- no lock-in.
